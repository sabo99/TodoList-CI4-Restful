...
class ProfileCallback {
    ...
    companion object {
         ...
         * Update Profile
         */
        fun onUpdateProfile(context: Context, user: User) {
            context.startActivity(Intent(context, EditProfile::class.java).putExtra("user", user))
        }

        fun onEnableOrDisableTwoFactorAuth(context: Context, user: User) {
            TwoFactorAuth.onStart(context, user)
        }
